...
from parsenet.trainer import TrainerParseNet
from common import TrainLogger,PascalDataloader,SBDDataloader
import albumentations as A

from parsenet.model import ParseNet
import yaml
...
if __name__ == "__main__":
    ...
    logger = TrainLogger("PARSENET")
    # Create ParseNet model
    model = ParseNet(in_channels=3,n_class=N_CLASSES)
    ...
    trainer = TrainerParseNet(model=model,logger=logger,cfg=cfg)

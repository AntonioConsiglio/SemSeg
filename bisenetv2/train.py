...
from common import TrainLogger,PascalDataloader,AUGSBDVocDataloader,set_all_seeds
...
if __name__ == "__main__":
    ...
    with open(os.path.join("bisenetv2","bisenetv2_cfg.yml"), 'r') as file:
    ...
    logger = TrainLogger("BiSeNETV2",exp_name=args.exp_name)
    # Create FCN model
    model = BiSeNetV2(in_channels=3,n_class=N_CLASSES,use_aux_heads=True)

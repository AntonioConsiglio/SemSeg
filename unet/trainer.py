...
class TrainerUNET(Trainer):
    ...
    def final_eval(self, val_loader: tqdm, pretrained_weights=None, checkpoint=None, AUGMENT=False, minhw = 512):
        ...
        if AUGMENT:
            self.augmenter = PadIfNeeded(p=1,min_height=minhw,min_width=minhw)

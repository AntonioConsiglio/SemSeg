...
from segformer.trainer import TrainerSegFormer
...
if __name__ == "__main__":
    ...
    with open(os.path.join("segformer","segformer_cfg.yml"), 'r') as file:
    ...
    logger = TrainLogger("SegFormer",exp_name=args.exp_name)
    # Create FCN model
    model = SegFormerB3(n_class=N_CLASSES)
